				...
				<form action="assets/process.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
					...
					<div class="form-row">
						...
						<div class="col mb-1">
							...
							<label for="validationCustom03">Country</label><span style="color: red !important; display: inline; float: none;">*</span>

							<select type="text" name="country" class="form-control" id="validationCustom03" placeholder="Country" required name="country" class="form-control">
...
-->
	...
	<div class="container-fluid m-0 px-0 ">
		 <div class="row ">
	<div class="col-lg-5 half-left-bottom">
